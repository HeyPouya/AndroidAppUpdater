...
import com.pouyaheydari.androidappupdater.store.stores.NINE_APPS_PACKAGE
import com.pouyaheydari.androidappupdater.store.stores.NINE_APPS_STORE_URL
...
internal class NineAppsTest {
    ...
    fun whenCalling_setStoreData_then_intentGetsFiredCorrectly() {
        ...
        val storeModel = ShowStoreModel(StoreFactory.getNineAppsStore(packageName), url)
