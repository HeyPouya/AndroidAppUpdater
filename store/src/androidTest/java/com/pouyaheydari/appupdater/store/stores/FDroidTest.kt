...
import com.pouyaheydari.androidappupdater.store.stores.FDROID_PACKAGE
import com.pouyaheydari.androidappupdater.store.stores.FDROID_URL
...
internal class FDroidTest {
    ...
    fun whenCalling_setStoreData_then_intentGetsFiredCorrectly() {
        ...
        val storeModel = ShowStoreModel(StoreFactory.getFdroidStore(packageName), url)
