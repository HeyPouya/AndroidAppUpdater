...
import com.pouyaheydari.androidappupdater.store.domain.stores.ONE_STORE_APP_MARKET_URL
...
internal class OneStoreAppMarketTest {
    ...
    fun whenCalling_setStoreData_then_intentGetsFiredCorrectly() {
        ...
        val storeModel = ShowStoreModel(StoreFactory.getOneStore(packageName))
