...
import com.pouyaheydari.androidappupdater.store.stores.PLAY_PACKAGE
import com.pouyaheydari.androidappupdater.store.stores.PLAY_URL
...
internal class GooglePlayStoreTest {
    ...
    fun whenCalling_setStoreData_then_intentGetsFiredCorrectly() {
        ...
        val storeModel = ShowStoreModel(StoreFactory.getGooglePlayStore(packageName), url)
